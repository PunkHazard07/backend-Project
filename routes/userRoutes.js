...
const { loginUser, registerUser, verifyEmail, resendVerificationEmail, logoutUser  } = require('../controllers/userController.js'); //destructure the functions from userController
